...
updateMasonry(event)});$(document).on('change.cards',function(event){updateMasonry(event)});$('.mbr-gallery-item').on('click','a',function(e){e.stopPropagation()});var timeout;var timeout2;function fitLBtimeout(){clearTimeout(timeout);timeout=setTimeout(fitLightbox,50)}
...
jQuery(document).ready(function($){ 
	...
	$('#click-demo').click(function (e) {
	  ...
	  $('body').addClass('active-demos');
	  
	})
	
	$('#close-demo').click(function (e) {
	  e.preventDefault()
	  $('body').removeClass('active-demos');
