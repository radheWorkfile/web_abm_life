...
<div class="alert alert-info">Your Wallet
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo site_url('member/topup_wallet') ?>" class="btn btn-xs btn-warning">Add
        More Fund &rarr;</a>
</div>
    ...
    <tbody>
        ...
        foreach ($result as $e) { ?>
            <tr>
                ...
                <?php } ?>
                <td>
                    <a href="javascript:;" onclick="document.getElementById('amt_div').style.display=<?php if ($e->amount > 0) {
                                                                                                            echo "'none'";
                                                                                                        } else echo "'block'"; ?>;document.getElementById('id').value='<?php echo $e->id ?>';document.getElementById('amt').value='<?php echo $e->amount ? $e->amount : '' ?>'; document.getElementById('ccode').innerHTML='<?php echo $e->pack_name ?>'" data-toggle="modal" data-target="#coupon" class="btn btn-info btn-xs">Invest Here</a>
                </td>
            </tr>
        <?php } ?>
    </tbody>
