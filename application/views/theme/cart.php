...
<head>
		...
		<!-- SITE TITLE -->
		<title>Camwel Solution || Cart Page</title>			
			...
			<div class="row">
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							<tr>
								<td class="image" data-title="No"><img src="assets/img/shop/cart1.jpg" alt="javaScript:void(0);"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="javaScript:void(0);">Women Dress</a></p>
							...
							<tr>
								<td class="image" data-title="No"><img src="assets/img/shop/cart2.jpg" alt="javaScript:void(0);"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="javaScript:void(0);">Women Dress</a></p>
									<p class="product-des">Maboriosam in a tonto nesciung eget  distingy magndapibus.</p>
								</td>
							...
							<tr>
								<td class="image" data-title="No"><img src="assets/img/shop/cart3.jpg" alt="javaScript:void(0);"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="javaScript:void(0);">Women Dress</a></p>
									<p class="product-des">Maboriosam in a tonto nesciung eget  distingy magndapibus.</p>
								</td>
						...
						<div class="row">
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<div class="checkbox">
										<label class="checkbox-inline" for="2"><input name="news" id="2" type="checkbox"> Shipping (+10Rs )</label>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li>You Save<span>Rs 20.00</span></li>
