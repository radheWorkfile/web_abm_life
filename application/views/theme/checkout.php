...
<head>
		...
		<title>CAMWEL SOLUTION  || Checkout Page</title>	
					...
					<div class="col-lg-4 col-12">
						<div class="order-details">
							...
							<div class="single-widget">
								...
								<div class="content">
									<ul>
										<li>Sub Total<span>Rs 330.00</span></li>
										<li>(+) Shipping<span>Rs 10.00</span></li>
										<li class="last">Total<span>Rs 340.00</span></li>
									</ul>
								</div>
							</div>
							<!--/ End Order Widget -->
							...
							<div class="single-widget payement">
								<div class="content">
									<img src="assets/img/payment-method.png" class="img-fluid" alt="javaScript:void(0);">
								</div>
							</div>
