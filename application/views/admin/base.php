...
<head>
    ...
    if (!isset($this->session->designation)) {
        ...
        $earnnings = $this->db_model->sum('topup_amount', 'topup_record');
        // $autopool_ear = $this->db_model->sum('autopool_amount', 'autopool_topup_record');
    }
    ?>
...
<body class="page-header-fixed sidemenu-closed-hidelogo page-container-bg-solid page-content-white page-md">
                            ...
                            <?php if (!isset($this->session->designation) || $this->session->designation['user_manage'] == "1") { ?>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="<?php echo site_url('users/guest-members') ?>" class="nav-link ">
                                                <span class="title">View/Guest Members</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
 ...
 लिए कृपया अपनी शेष राशि का भुगतान करें !</div>';
                            ...
                            <div class="state-overview">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="overview-panel red">
                                        ...
                                        <div class="value white">
                                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="23"><?php echo count($new_member); ?></p>
                                            <p>Guest Member</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="card card-topline-aqua" style=" max-width:100%;">
                                    <div class="card-body no-padding  ">
                                        <div class="row">
                                            <div id="donutchart" style="max-height:300px"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
