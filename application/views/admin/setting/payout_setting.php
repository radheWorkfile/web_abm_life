...
<div class="row">
    ...
    <div class="col-sm-6">
        <label>Payout Admin TAX (%)</label>
        <input type="text" class="form-control" value="<?php echo set_value('payout_admin_tax', config_item('payout_admin_tax')) ?>"
               name="payout_admin_tax">
    </div>
    <div class="col-sm-6">
