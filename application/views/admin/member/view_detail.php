...
<div align="center">
    <img src="<?php echo $data->my_img ? base_url('uploads/' . $data->my_img) : base_url('uploads/default.jpg'); ?>" class="img-responsive img-rounded" style="max-width: 600px">
</div>
<div class="row view">
    ...
    <div class="col-sm-6"><strong>Password: </strong> <?php echo $data->show_password; ?></div>
</div>
...
<div class="row view">
    ...
    <div class="col-sm-6"><strong>Registration Date: </strong> <?php echo date('d M Y',strtotime($data->join_time)); ?></div>
